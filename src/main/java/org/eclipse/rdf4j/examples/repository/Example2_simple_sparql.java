...
/**
 * Adding data to a {@link Repository}: a simple SPARQL query
 * 
 */
public class Example2_simple_sparql {

	public static void main(String[] args) throws Exception {
		URL data = Example2_simple_sparql.class.getResource("/example-data-artists.ttl");
